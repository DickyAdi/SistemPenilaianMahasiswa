...
public class cariData extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1058, 787));
        ...
        jPanel3Layout.columnWidths = new int[] {0, 80, 0, 80, 0};
        jPanel3Layout.rowHeights = new int[] {0};
        jPanel3.setLayout(jPanel3Layout);

        jButton2.setBackground(new java.awt.Color(51, 153, 255));
        jButton2.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/name (icon).png"))); // NOI18N
        jButton2.setText("Cari Nama Mahasiswa");
        ...
        jButton3.setText("Cari Mata Kuliah");
