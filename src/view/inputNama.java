...
public class inputNama extends javax.swing.JFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (tfNama.getText() != null && tfNim.getText() != null){
            String que = "INSERT INTO mahasiswa(nama, nim)" + "VALUES ('"+tfNama.getText()+"','"+ tfNim.getText()+"')";
            int conf = JOptionPane.showConfirmDialog(this, "Tambahkan?");
